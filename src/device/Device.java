...
public class Device {
    ...
    private JsonWire uiautomatorWire;
    ...
    public Device(String adbLocation, IDevice device) {
        ...
        this.device = device;
        this.uiautomatorWire = openUiAutomator();
    }
    ...
    private JsonWire openUiAutomator(/* params needed */) {
        ...
        uiAutomatorExecutor.execute(new Runnable() {
            ...
            public void run() {
                ...
                } catch (SyncException | IOException | AdbCommandRejectedException | TimeoutException
        ...
        */
        try {
            device.createForward(PORT_UI_AUTOMATOR, PORT_UI_AUTOMATOR);
            return new JsonWire(new Socket("localhost", PORT_UI_AUTOMATOR));
